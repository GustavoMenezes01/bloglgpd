  ...
  <div class="container">
    ...
    <div class="">
      ...
      <div class="col-md-12">
        ...
        <h1 class="my-4">Privacidade de Dados
          <small>Dúvidas</small>
        </h1>

        <!-- Blog Post -->
        <div class="card mb-4">
          <img class="card-img-top" src="img/A-Lei-Geral-de-Proteção-de-Dados-Pessoais.png" height="450" alt="Card image cap">
          <div class="card-body">
            <h2 class="card-title">Titulo do post</h2>
            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis aliquid atque, nulla? Quos cum ex quis soluta, a laboriosam. Dicta expedita corporis animi vero voluptate voluptatibus possimus, veniam magni quis!</p>
            <a href="#" class="btn btn-primary">Respostas &rarr;</a>
          </div>
          <div class="card-footer text-muted">
            Postado em Março 12, 2020 por
            <a href="#">Usuário tal</a>
          </div>
        </div>
